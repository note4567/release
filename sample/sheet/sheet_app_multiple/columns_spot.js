function makeFilter(cell, formatterParams, onRendered){
  // return `${cell.getValue()}<span class="filter_obj" data-type=filter></span>`
...
const columnDefinitions = [
  ...
  { title: "No", field: "no", cssClass: "custom", editor: "input" ,headerSort: false, titleFormatter: makeFilter},
  { title: "Site", field: "site", cssClass: "custom", editor: "input" ,headerSort: false, titleFormatter: makeFilter},
  ...
  { title: "Format", field: "format", cssClass: "custom", editor: "input" ,headerSort: false, titleFormatter: makeFilter},
  { title: "Result", field: "result", cssClass: "custom", editor: "input" ,headerSort: false, titleFormatter: makeFilter},
  { title: "Deadline", field: "deadline", cssClass: "custom", headerSort: false, editor:"date", editorParams:{
    min:"01/01/1955", format:"yyyy/MM/dd", verticalNavigation:"table", 
    elementAttributes:{
        title:"slide bar to choose option"
    }
  }, titleFormatter: makeFilter},
  { title: "Start", field: "start", cssClass: "custom", headerSort: false, editor:"date", editorParams:{
    min:"01/01/1955", format:"yyyy/MM/dd", verticalNavigation:"table", 
    elementAttributes:{
        title:"slide bar to choose option"
    }
  }, titleFormatter: makeFilter},
  { title: "End", field: "end", cssClass: "custom", headerSort: false, editor:"date", editorParams:{
    min:"01/01/1955", format:"yyyy/MM/dd", verticalNavigation:"table", 
    elementAttributes:{
        title:"slide bar to choose option"
    }
