// #todo ---------------------------------------------------------------------------------------------------
    ...
    // 2024/09/05 ブランドシートの作成 → 作成中
    // 2024/09/06 優先・定期シートの作成 → 
    // 2024/09/06 フィルターのデザイン変更 →
    // ---------------------------------------------------------------------------------------------------
...
// var table = new Tabulator("#brand_table", {
//     // layout:"fitColumns",
//     data: [        
...
function checkSheetWidth(){
    // console.log(table['interactionMonitor']['table'].getBoundingClientRect())
    let tableElement = document.querySelector('div.tabulator-table')
    // let tableElement = document.querySelector('section div')
    console.log('tableElement:',tableElement)
    // console.log('tableElement:',table['interactionMonitor']['table'])
    // console.log(Object.entries(table['interactionMonitor']['table']))
   
    // console.log(Object.keys(table))
    // console.log(Object.entries(table))
    // console.log(Object.values(table))
    (columnDefinitions.length -2) * 150 + 10
    console.log(columnDefinitions.length -1);
    const tableSize = tableElement.getBoundingClientRect();
    
    console.log('talbeSize:',tableSize)
    if (tableSize['width'] < 1350){
        tableElement.style=`max-width: ${tableSize}px`
    }
}
