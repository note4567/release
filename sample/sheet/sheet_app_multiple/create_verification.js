...
var table = new Tabulator("#verification_table", {
    // layout:"fitColumns",
    data: [        
        { id:991, brand: 122, script: 1045, lbc:12345678901,name: "ミスタードーナツ", url: "https://www.misterdonut.jp/",
        yagou:"Mister Donut", item1:"定休日", item2:"", records:23, date:"2023/10/11", status:8.5, flag:0, finish:true,erase:'削除',cssClass: "custom"},        
