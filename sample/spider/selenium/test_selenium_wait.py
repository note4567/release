...
try:
    ...
    wait.until(expected_conditions.presence_of_element_located((By.XPATH, '//title')))
    # 1行で書く場合
    # WebDriverWait(selem.driver, 30).until(expected_conditions.presence_of_element_located((By.XPATH, '//title')))
    print(selem.driver.find_element(By.XPATH, '//title').get_attribute("textContent"))
finally:
    print("end")
    selem.driver.quit()
